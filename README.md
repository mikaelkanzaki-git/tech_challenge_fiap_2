...
Projeto de triagem hospitalar com modelo de Machine Learning, API FastAPI, autenticação JWT, persistência em PostgreSQL e frontend com entrevista guiada por agente conversacional.
...
Se esses arquivos não existirem, a API pode iniciar, mas o serviço de predição não estará pronto para responder corretamente.
